...
updated: 2026-06-16
type: concept
tags: [集成方法, quant, factor, strategy]
sources: [Multimodal Evaluator Preference Collapse: Cross-Modal Contagion in Self-Evolving Agents]
confidence: medium
---

# Multimodal Evaluator Preference Collapse: Cross-Modal Contagion in Self-Evolving Agents

> 来源：[arXiv:2606.16682v1](https://arxiv.org/abs/2606.16682v1) | 作者：
...
- Using GPT-4o to evaluate DeepSeek-chat across text and visual tasks, we find that a single strategy (step_by_step) absorbs 48.
