...
updated: 2026-05-27
type: index
tags: [quant, riding-bull, teachings]
confidence: medium
---
...
- [[../subjective-trading-system]] — **主观交易系统完整版**（综合骑牛登山40+技术+ TGM实战经验 + 全量回测验证 — 九卷体系：哲学/诊断/选股/买入/仓位/离场/特殊模式/日常流程/心理法则）
...
- [[slanted-parallel-lines]] — **斜横线与平行线/黄金坑**（两点连线下降趋势线·阴实底/顶平行线·变盘节点出中大K线·跌破放量站回=黄金坑V反）
- [[chip-peak-abc]] — **筹码峰ABC**（解放战法·低开阴线定位·右侧量>左侧=主升启动）
...
### 妖股与龙头
- [[yaogu-dragon-leading]] — **妖股与龙头战法**（板块定龙术·龙一首阴·连板见顶量价时空倒着念·妖股两大基因·龙头交接）

### 实战教学/综合运用
- [[abc-buying-practice]] — **ABC买入法实战推演**（静态交易练习·综合MACD/空间/八字要诀/筹码/DMI多技术联动做决策，实盘收益率+125%）
- [[static-training-practice]] — **静态交易练习方法论**（训练模式高级设置·自动播放推演·数字操盘辅助·阴实底/阴虚底风控细节，实盘收益率+65%）
...
> updated: YYYY-MM-DD
> type: concept
> tags: [quant, riding-bull, teachings, [具体标签]]
> confidence: medium
> source: [视频日期/名称]
> ---
>
